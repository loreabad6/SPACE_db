...
================
Lorena Abad
14.07.2022 updated: 09.08.2022

# Read DB data

We will first, as usual, connect to the database to be able to access
the created tables.
...
Reading the data now should not be much effort, you can expand the code
below:
...
We can combine all the information of the three tables into one single
table to pick information for the sunburst visualization:
...
# lapply(1:nrow(curricula), function(x){
  ...
  ggsave(
    filename = paste0("plots/sb_curricula_", x, ".png"),
